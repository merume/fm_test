...
declare module "dets" {
  ...
  export function processVisitorContext(context: DeclVisitorContext, plugins: Array<DetsPlugin>): void;
  ...
  export function generateDeclaration(options: DeclOptions): string;
  ...
  export function retrieveTypings(options: TypingOptions): TypeRefs;
