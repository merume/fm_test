...
function getName(dir) {
    const location = (0, path_1.resolve)(dir, 'package.json');
...
function writeFile(path, content) {
    const full = (0, path_1.resolve)(root, path);
    const dir = (0, path_1.dirname)(full);
    if (!(0, fs_1.existsSync)(dir)) {
        (0, fs_1.mkdirSync)(dir, { recursive: true });
    }
    (0, fs_1.writeFileSync)(full, content, 'utf8');
}
function runScript(script, cwd) {
    return new Promise((resolve, reject) => {
        const cp = (0, child_process_1.exec)(script, { cwd });
...
try {
    ...
    runScript('npm install typescript@3.x', (0, path_1.resolve)(__dirname, '..')).then(runCli);
}
