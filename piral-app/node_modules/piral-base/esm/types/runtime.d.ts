 ...
 */
export declare type PiletApp = SinglePiletApp | MultiPiletApp;
/**
 ...
 */
export declare type SinglePilet = SinglePiletApp & PiletMetadata;
/**
 * An evaluated multi pilet.
 */
export declare type MultiPilet = MultiPiletApp & PiletMetadata;
/**
 * An evaluated pilet, i.e., a full pilet: functionality and metadata.
 */
export declare type Pilet = SinglePilet | MultiPilet;
