 ...
 */
export declare type PiletV0Entry = PiletV0ContentEntry | PiletV0LinkEntry;
/**
 ...
 */
export declare type SinglePiletEntry = PiletV0Entry | PiletV1Entry | PiletV2Entry | PiletVxEntry;
/**
 * The metadata response for a multi pilet.
 */
export declare type MultiPiletEntry = PiletBundleEntry;
/**
 * Pilet entry representing part of a response from the feed service.
 */
export declare type PiletEntry = MultiPiletEntry | SinglePiletEntry;
/**
 * The entries representing pilets from a feed service response.
 */
export declare type PiletEntries = Array<PiletEntry>;
