...
import type { WrappedComponent, Dict, BaseComponentProps, AnyComponent, BaseRegistration, RegistrationDisposer } from 'piral-core';
...
export declare type StandardMenuType = 'general' | 'admin' | 'user' | 'header' | 'footer';
export declare type MenuType = StandardMenuType | keyof PiralCustomMenuTypes;
