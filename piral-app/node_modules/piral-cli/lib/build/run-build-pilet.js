    ...
    try {
        switch (msg.type) {
            case 'init':
                ...
                break;
            case 'start':
                const bundler = yield run(process.cwd(), msg.piralInstances, msg.sourceMaps, msg.watch, msg.contentHash, msg.minify, msg.externals, msg.importmap, msg.targetDir, msg.outDir, msg.outFile, msg.entryModule, msg.version, msg.logLevel, msg);
