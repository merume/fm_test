...
const bundlers = [];
function getBundlerToInstall() {
    return __awaiter(this, void 0, void 0, function* () {
        const selectedBundler = common_1.config.bundler || 'webpack5';
        if ((0, external_1.isInteractive)()) {
            return yield (0, common_1.promptSelect)('No bundler found. Which one do you want to install?', common_1.bundlerNames, selectedBundler);
        }
...
function installDefaultBundler(root) {
    return __awaiter(this, void 0, void 0, function* () {
        const selectedBundler = yield getBundlerToInstall();
        ...
        yield (0, common_1.installNpmPackage)(client, packageId, root, '--save-dev', '--save-exact');
