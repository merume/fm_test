...
always-auth=true`, forceOverwrite);
            ...
            yield (0, common_1.createFileIfNotExists)(root, 'pilet.json', JSON.stringify({
                schemaVersion: 'v2',
            }, undefined, 2));
            const [packageName, packageVersion] = yield (0, common_1.installPiralInstance)(source || `empty-piral@${common_1.cliVersion}`, fullBase, root, npmClient);
