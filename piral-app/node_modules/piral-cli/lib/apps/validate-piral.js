...
exports.validatePiral = exports.validatePiralDefaults = void 0;
...
function validatePiral(baseDir = process.cwd(), options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const rules = yield (0, rules_1.getPiralRules)();
        const entryFiles = yield (0, common_1.retrievePiralRoot)(fullBase, entry);
        const _a = yield (0, common_1.retrievePiletsInfo)(entryFiles), { root, dependencies, ignored: _, externals } = _a, info = __rest(_a, ["root", "dependencies", "ignored", "externals"]);
        const errors = [];
        const warnings = [];
        yield (0, common_2.checkCliCompatibility)(root);
        const context = {
            error(message) {
        ...
        yield (0, common_1.runRules)(rules, context, common_1.config.validators);
