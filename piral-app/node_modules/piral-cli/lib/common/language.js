...
exports.getDevDependencies = exports.getDependencies = exports.getFrameworkDependencies = exports.getDevDependencyPackages = exports.getDependencyPackages = void 0;
...
function getDependencyPackages(framework, reactVersion, reactRouterVersion) {
    ...
    return framework === 'piral-base'
        ? {}
        : Object.assign(Object.assign({}, (reactVersion < 18 ? react17Deps : react18Deps)), (reactRouterVersion < 6 ? reactRouter5Deps : reactRouter6Deps));
}
...
function getDevDependencyPackages(framework, reactVersion, reactRouterVersion) {
    ...
    return framework === 'piral-base'
        ? {}
        : Object.assign(Object.assign({}, (reactVersion < 18 ? react17Typings : react18Typings)), (reactRouterVersion < 6 ? reactRouter5Typings : {}));
}
exports.getDevDependencyPackages = getDevDependencyPackages;
function getFrameworkDependencies(framework, version) {
    return Object.assign(Object.assign(Object.assign({}, (framework !== 'piral-base' ? { 'piral-base': `${version}` } : {})), (framework !== 'piral-base' && framework !== 'piral-core' ? { 'piral-core': `${version}` } : {})), { [framework]: `${version}` });
}
...
function getDevDependencies(language, typings = defaultTypings) {
    switch (language) {
        case 'ts':
            return Object.assign(Object.assign({}, typings), { '@types/node': 'latest', typescript: 'latest' });
        case 'js':
            return {};
        default:
