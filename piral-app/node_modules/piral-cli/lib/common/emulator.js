...
function createEmulatorSources(sourceDir, externals, targetDir, targetFile, logLevel) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const piralPkg = require((0, path_1.resolve)(sourceDir, constants_1.packageJson));
        ...
        yield (0, io_1.createFileIfNotExists)(rootDir, constants_1.packageJson, '{}');
        // patch the JSON relevant for th eproject
        yield (0, io_1.updateExistingJson)(rootDir, constants_1.packageJson, {
            name: piralPkg.name,
            ...
            sharedDependencies: (0, package_1.flattenExternals)(externals),
        ...
        yield (0, package_1.copyScaffoldingFiles)(sourceDir, rootDir, (_c = piralPkg.files) !== null && _c !== void 0 ? _c : []);
        ...
        yield (0, declaration_1.createPiralDeclaration)(sourceDir, (_d = piralPkg.app) !== null && _d !== void 0 ? _d : `./src/index.html`, targetDir, enums_1.ForceOverwrite.yes, logLevel);
