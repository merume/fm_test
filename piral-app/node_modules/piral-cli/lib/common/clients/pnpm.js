...
function installDependencies(target = '.', ...flags) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield runPnpmProcess(['install', ...convert(flags)], target, ms);
...
function uninstallPackage(packageRef, target = '.', ...flags) {
    return __awaiter(this, void 0, void 0, function* () {
        const ms = new MemoryStream_1.MemoryStream();
        yield runPnpmProcess(['remove', packageRef, ...convert(flags)], target, ms);
...
function installPackage(packageRef, target = '.', ...flags) {
    return __awaiter(this, void 0, void 0, function* () {
        const ms = new MemoryStream_1.MemoryStream();
        yield runPnpmProcess(['add', packageRef, ...convert(flags)], target, ms);
...
function detectClient(root, stopDir = (0, path_1.resolve)(root, '/')) {
    return __awaiter(this, void 0, void 0, function* () {
        return !!(yield (0, io_1.findFile)(root, ['pnpm-lock.yaml', 'pnpm-workspace.yaml'], stopDir));
    });
}
...
function listProjects(target) {
    return __awaiter(this, void 0, void 0, function* () {
        const ms = new MemoryStream_1.MemoryStream();
        try {
            yield runPnpmProcess(['list', '--json', '--recursive', '--depth', '0'], target, ms);
        }
        catch (e) {
