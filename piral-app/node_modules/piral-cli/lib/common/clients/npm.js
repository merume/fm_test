...
exports.listPackage = exports.findTarball = exports.findSpecificVersion = exports.publishPackage = exports.createPackage = exports.unpackPackage = exports.loginUser = exports.initProject = exports.isProject = exports.detectClient = exports.installPackage = exports.uninstallPackage = exports.installDependencies = void 0;
...
function uninstallPackage(packageRef, target = '.', ...flags) {
    return __awaiter(this, void 0, void 0, function* () {
        const ms = new MemoryStream_1.MemoryStream();
        yield runNpmProcess(['uninstall', packageRef, ...flags], target, ms);
...
function detectClient(root, stopDir = (0, path_1.resolve)(root, '/')) {
    return __awaiter(this, void 0, void 0, function* () {
        return !!(yield (0, io_1.findFile)(root, 'package-lock.json', stopDir));
    });
}
