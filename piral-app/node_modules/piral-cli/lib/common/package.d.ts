...
import { SourceLanguage, Framework, FileInfo, PiletsInfo, TemplateFileLocation, PiletPackageData, PiralPackageData, SharedDependency, PiletDefinition, AppDefinition, PiralInstancePackageData } from '../types';
...
export declare function findPiralInstance(proposedApp: string, baseDir: string, port: number): Promise<PiralInstancePackageData>;
export declare function findPiralInstances(proposedApps: Array<string>, piletPackage: PiletPackageData, piletDefinition: undefined | PiletDefinition, baseDir: string): Promise<PiralInstancePackageData[]>;
...
export declare function flattenExternals(dependencies: Array<SharedDependency>): string[];
...
export declare function retrievePiletsInfo(entryFile: string): Promise<{
    ...
    name: any;
    version: any;
    framework: "piral-native" | "piral" | "piral-core" | "piral-base";
    dependencies: {
        std: any;
        dev: any;
        peer: any;
...
export declare function patchPiletPackage(root: string, name: string, version: string, piralInfo: PiralPackageData, fromEmulator: boolean, newInfo?: {
    language: SourceLanguage;
    bundler: string;
}): Promise<void>;
/**
