 ...
 * ```
 */
export declare function expectedArray_0072(key: string, type: string): QuickMessage;
/**
 * @kind Error
 *
 * @summary
 ...
 * same repository.
 */
export declare function entryPointDoesNotExist_0073(app: string): QuickMessage;
/**
 * @kind Error
 *
 * @summary
 ...
 */
export declare function packageJsonMissing_0074(): QuickMessage;
/**
 * @kind Error
 *
 * @summary
 ...
 */
export declare function packageJsonMissing_0075(): QuickMessage;
/**
 * @kind Error
 *
 * @summary
 ...
 * ...
 */
export declare function validationFailed_0080(errors: number): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * ...
 */
export declare function validationWarned_0081(warnings: number): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * ```
 */
export declare function appShellIncompatible_0100(piralVersion: string, cliVersion: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * ```
 */
export declare function publishDirectoryMissing_0110(directory: string): QuickMessage;
/**
 * @kind Error
 *
 * @summary
 ...
 * ```
 */
export declare function publishEmulatorFilesUnexpected_0111(directory: string): QuickMessage;
/**
 * @kind Error
 *
 * @summary
 ...
 * ```
 */
export declare function failedToOpenBrowser_0170(error: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * ```
 */
export declare function invalidSchemaVersion_0171(schemaVersion: string, schemas: Array<string>): QuickMessage;
/**
 * @kind Error
 *
 * @summary
 ...
 * ```
 */
export declare function bundlerMissing_0172(bundlerName: string, installed: Array<string>): QuickMessage;
/**
 * @kind Error
 *
 * @summary
 ...
 * ```
 */
export declare function defaultBundlerMissing_0173(): QuickMessage;
/**
 * @kind Error
 *
 * @summary
 ...
 * ```
 */
export declare function bundlingFailed_0174(error: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * ...
 */
export declare function apiCommandNameInvalid_0200(type: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * ...
 */
export declare function apiArgumentInvalid_0201(name: string, type: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * ...
 */
export declare function apiValidateNameInvalid_0202(type: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * ...
 */
export declare function apiValidateRunInvalid_0203(type: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * ...
 */
export declare function apiPatchInvalid_0204(name: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * ...
 */
export declare function pluginCouldNotBeLoaded_0205(pluginPath: string, ex: any): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * ...
 */
export declare function apiBundlerInvalid_0206(name: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * ...
 */
export declare function apiReleaseProviderInvalid_0207(name: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 */
export declare function piletMultiDebugAppShellDifferent_0301(expected: string, actual: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * remove the invalid pilet.
 */
export declare function piletMultiDebugAppShellVersions_0302(expected: string, actual: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * remove the invalid pilet.
 */
export declare function piletMultiDebugExternalsDifferent_0303(expected: Array<string>, actual: Array<string>): QuickMessage;
