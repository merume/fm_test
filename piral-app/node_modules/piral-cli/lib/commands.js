...
function specializeCommand(commands, command, suffix) {
    if (command.name.endsWith(suffix)) {
        commands.push(Object.assign(Object.assign({}, command), { name: command.name.replace(suffix, ''), alias: command.alias.filter((n) => n.endsWith(suffix)).map((n) => n.replace(suffix, '')) }));
    }
}
    ...
    },
    {
        ...
        flags(argv) {
            return argv
                ...
                .choices('provider', helpers_1.availableReleaseProviders)
