 ...
 * ```
 */
function unsuccessfulHttpPost_0066(statusText, statusCode, error) {
    return [
        types_1.LogLevels.warning,
        '0066',
 ...
 * ```
 */
function httpPostResponse_0067(response) {
 ...
 */
function failedToUploadPayment_0161(response) {
    const content = typeof response !== 'string' ? JSON.stringify(response, undefined, 2) : response;
 ...
 */
function failedToUploadVersion_0162(response) {
    const content = typeof response !== 'string' ? JSON.stringify(response, undefined, 2) : response;
 ...
 */
function failedToUploadSize_0163(response) {
    const content = typeof response !== 'string' ? JSON.stringify(response, undefined, 2) : response;
 ...
 */
function packageJsonMissing_0074() {
    return [
        types_1.LogLevels.error,
        '0074',
 ...
 * ```
 */
function appShellIncompatible_0100(piralVersion, cliVersion) {
    return [
        types_1.LogLevels.warning,
        '0100',
 ...
 * ```
 */
function toolingIncompatible_0101(piralVersion, cliVersion) {
    return [
        types_1.LogLevels.warning,
        '0101',
 ...
 * ```
 */
function invalidSchemaVersion_0171(schemaVersion, schemas) {
 ...
 * ```
 */
function bundlerMissing_0172(bundlerName, installed) {
 ...
 * ```
 */
function bundlerUnspecified_0175(available) {
 ...
 * remove the invalid pilet.
 */
function piletMultiDebugExternalsDifferent_0303(expected, actual) {
